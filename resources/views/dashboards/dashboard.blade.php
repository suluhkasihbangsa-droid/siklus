                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-01"
                                        ...
                                        data-value="{{ $persentaseSasaranDiregister }}" data-type="percent">
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 class="counter">{{ $jumlahSasaranDiregister }}</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-02"
                                        ...
                                        data-min-value="0" data-max-value="100"
                                        data-value="{{ $persentaseSasaranDiperiksa }}" data-type="percent">
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-03"
                                        class="circle-progress-01 circle-progress circle-progress-primary text-center"
                                        data-min-value="0" data-max-value="100"
                                        data-value="{{ $persentaseSasaranKonsultasi }}" data-type="percent">
