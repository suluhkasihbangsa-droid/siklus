...
<li class="nav-item">
    {{-- Menu Utama --}}
    <a class="nav-link" data-bs-toggle="collapse" href="#manajemen-data" role="button" aria-expanded="false" aria-controls="manajemen-data">
        <i class="icon">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="item-name">Manajemen Data</span>
        <i class="right-icon">
    ...
    {{-- Sub-Menu --}}
    <ul class="sub-nav collapse" id="manajemen-data" data-bs-parent="#sidebar">
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('sasaran.index')) }}" href="{{ route('sasaran.index') }}">
                <i class="icon">
                ...
                <span class="item-name">Sasaran</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('pemeriksaan.index')) }}" href="{{ route('pemeriksaan.index') }}">
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                        <g><circle cx="12" cy="12" r="8" fill="currentColor"></circle></g>
                    </svg>
        ...
        @role('admin')
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('organisasi.index')) }}" href="{{ route('organisasi.index') }}">
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                        <g><circle cx="12" cy="12" r="8" fill="currentColor"></circle></g>
                    </svg>
                ...
                <span class="item-name">Organisasi</span>
            </a>
        </li>
        @endrole
    </ul>
    ...
    {{-- ====================================================== --}}
    {{-- = KODE BARU UNTUK MENU KONSULTASI (KHUSUS DOKTER) --}}
    {{-- ====================================================== --}}
    @hasanyrole('admin|dokter')
    <li class="nav-item">
        {{-- Tautan Utama Menu --}}
        <a class="nav-link {{ activeRoute(route('konsultasi.index')) }}" href="{{ route('konsultasi.index') }}">
            <i class="icon">
                {{-- Ikon Stetoskop untuk Konsultasi --}}
                <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-heart-pulse" viewBox="0 0 16 16">
                    <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053.918 3.995.78 5.323 1.508 7H.43c-2.128-5.697 4.165-8.803 7.5-8.228 3.335.575 4.137 3.323 3.36 6.223H14.5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1.32c-.318.995-1.013 1.938-2.072 2.742A6.5 6.5 0 0 1 8 14.5c-2.31 0-4.223-1.252-5.186-3.033H1.5a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h1.103a5.5 5.5 0 0 1-.412-1.558C1.34 5.484 2.642 3.9 4.314 3.053c1.23-1.6 3.93-1.343 5.4.3L10.5 4.604l.71-.71a.5.5 0 0 1 .708 0l1.414 1.415a.5.5 0 1 1-.707.707l-1.415-1.414-.853.854a.5.5 0 0 1-.708 0l-1.925-1.926-.738.738a.5.5 0 1 1-.707-.707z"/>
                    <path d="M10.121 9.423a.5.5 0 0 1-.708.707L8 8.811 6.586 10.13a.5.5 0 0 1-.707-.707l1.414-1.414L6 6.793a.5.5 0 0 1 .707-.707L8 7.396l1.414-1.414a.5.5 0 0 1 .708.707L8.707 8.1l1.414 1.323z"/>
                </svg>
            </i>
...
@role('admin')
    ...
    <li class="nav-item">
        {{-- Menu Utama --}}
        <a class="nav-link" data-bs-toggle="collapse" href="#pengaturan-sistem" role="button" aria-expanded="false" aria-controls="pengaturan-sistem">
            <i class="icon">
                {{-- Icon "Settings" --}}
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.1223 2.55615H9.87771C6.67771 2.55615 4.88871 4.34515 4.88871 7.54515V16.4541C4.88871 19.6541 6.67771 21.4431 9.87771 21.4431H14.1223C17.3223 21.4431 19.1113 19.6541 19.1113 16.4541V7.54515C19.1113 4.34515 17.3223 2.55615 14.1223 2.55615Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M12 15.4441C13.886 15.4441 15.422 13.9081 15.422 11.9991C15.422 10.0911 13.886 8.55505 12 8.55505C10.114 8.55505 8.57802 10.0911 8.57802 11.9991C8.57802 13.9081 10.114 15.4441 12 15.4441Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </i>
        ...
        {{-- Sub-Menu --}}
        <ul class="sub-nav collapse" id="pengaturan-sistem" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('users.index'))}}" href="{{ route('users.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('aturan-interpretasi.index'))}}" href="{{ route('aturan-interpretasi.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g><circle cx="12" cy="12" r="8" fill="currentColor"></circle></g>
                        </svg>
                    ...
                    <i class="sidenav-mini-icon"> S </i>
                    <span class="item-name">Standar Interpretasi</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('obat.index'))}}" href="{{ route('obat.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g><circle cx="12" cy="12" r="8" fill="currentColor"></circle></g>
                        </svg>
